...
##########################################################################
VAR_FORM=$( \
   ${OPEN} | GTK_THEME="Ncode Light Theme" yad --form --borders=10 \
        --center \
...
$ERRO | GTK_THEME="Ncode Light Theme" yad --title="Aviso !"       \
    --center                                    \
    --width=400                                 \
    --height=100                                \
...
#.EOF
  ...
  GTK_THEME="Ncode Light Theme" yad --title="Parabéns, Código Gerado !"            \
      --center                                       \
      --width=350                                    \
      --height=110                                   \
